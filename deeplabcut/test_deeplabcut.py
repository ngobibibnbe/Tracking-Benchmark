...
import sys
sys.path.append('/home/sophie/uncertain-identity-aware-tracking/deeplabcut/pig_tracking_dataset')
import deeplabcut 
...
def test_deeplabcut(config_path, iteration=0):
    ...
    scorername= deeplabcut.analyze_videos(config_path,video_path, videotype='.mp4',shuffle=1, gputouse=0, save_as_csv=True) 
    print("finish analyze video")
    # n_tracks=15, calibrate=True,gputouse=0,auto_track=False)#auto_track=True#deeplabcut.convert_detections2tracklets(config_path,["/home/sophie/uncertain-identity-aware-tracking/deeplabcut/videos/GR77_20200512_111314.mp4"], videotype='.mp4', window_size=0, calibrate=False, overwrite=True)
