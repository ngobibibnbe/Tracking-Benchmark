...
is_it_random =False
#exp="_low"
exp="_bytetrack_low_random_50_50"
exp="_bytetrack_low_random"
exp="_bytetrack_low_no_random"

for dataset_name in folders:
    if True: #dataset_name==  "MOT17-11-FRCNN": # or dataset_name==  "MOT17-04-FRCNN":
        ...
        base_path= home_folder+"YOLOX_outputs/yolox_x_ablation/videos/"+dataset_name+"/gt_video"
        ...
        def score_for_various_artificial_observations_mot():
            ...
            base_path_2 =  "/data/home/sophie/sophie_2024-10-08/uncertain-identity-aware-tracking/Bytetrack/YOLOX_outputs/yolox_x_ablation/track_results/"+dataset_name
            '''
            ...
            for j in range(0,1,1):
                ...
                for i in range (4000, 4001 , 200):# range (2, 200 , 10): #[10, 100]:#  [18]: # len(label_track.keys())            
                    ...
                    try:
                        ...
                        process_forwad_backward(observation_file,nbr_visit="per_id_"+str(nbr_visits), pigs_HMM=False, json_save_path=Hmm_result_file, video_path=video_path)
                    ...
                    nbr_visits =adding_atq(nbr_visit=i,curated_artificial_visit=None, output_file=observation_file, feeder=False, 
                                ...
                                dbn_file= base_path_2+"_DBN_result.json",
                                labels_file=gt_path,
                            is_it_random = is_it_random, model=False,fairmot=False, for_re_id=True)
                    re_id_track_result_file = base_path+"_per_id_re_id.json"
                    tracking_result =produce_re_id_results(track_with_observation_file =observation_file , tracking_file=base_path_2+"_tracking_result.json", re_id_track_result_file = re_id_track_result_file , save_video=True, video_path=gt_video_path)
                    ...
                    hmm_result_with_visits.to_csv(base_path+'accuracy_over_nbr_of_visits_with_track_helping_nr'+exp+'.csv')
                    re_id_result_with_visits.to_csv(base_path+'accuracy_Re_id_over_nbr_of_visits_with_track_helping_nr'+exp+'.csv')
                    #break
